<template>
  <div style="width: 100%;font-size: 0;">
    <span :style="span_style" class="filter_span">所属部门</span>
...
<script>
  export default {
    ...
    mounted(){
         this.$ajax.get(this.$URL+'/config/GetSelectDept').then((result) => {
    ...
    //   this.pubSend('/device/GetDeviceDepartMent',{},false).then(data =>{
    //     if(data.success){
