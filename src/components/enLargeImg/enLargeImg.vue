<template>
  <div class="layout-mgt-30">
    ...
    <div v-for="(item,index) in picData" :key="index">
    ...
    <div v-if="largeContainer" class="largeContainer">
      <div class="fl sideClick">
        <div @click="prevImg">
          <img src="@/static/images/left_arrow.png" class="clickArrow">
        </div>
      </div>
      ...
      <div class="fr sideClickR">
        <div @click="nextImg">
          <img src="@/static/images/right_arrow.png" class="clickArrow">
        </div>
      </div>
    </div>
    <div class='bottom' v-if="largeContainer">
      <img src="@/static/images/large.png" class='rotate' @click="largeImg">
      <img src="@/static/images/small.png" class='rotate' @click="smallImg">
      <img src="@/static/images/circle.png" class='rotate' @click="rotateImg">
      <img src="@/static/images/circle1.png" class='rotate' @click="rotateImgBack">
    </div>
  </div>
</template>
...
export default {
  ...
  mounted(){
    if(this.data.length>0){
      this.picData=this.data.map(item =>{
        let url ={
             path:process.env.BASE_API + item
           }
          return url
      })
    }else{
