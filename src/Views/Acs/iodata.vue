    ...
    <div class="h100">
        <div class="filter">
            ...
            <div class="filter_line">
             ...
             <!-- <div class="filter_line">
                <el-input v-model="keyword" placeholder="支持 区域 查询"></el-input>
            </div> -->
            <div class="filter_line">
                <el-input v-model="keyword" placeholder="支持 门禁 姓名 查询"></el-input>
            </div>
            <div class="filter_line">
        ...
        <el-table :data="tableData" style="width: 100%" class="usertable">
            ...
            <el-table-column prop="EventAlarmCode" label="事件">
            </el-table-column>
            <el-table-column prop="InOutIndication" label="进出方向">
            </el-table-column>
            <el-table-column prop="emName" label="姓名">
            </el-table-column>
            <el-table-column prop="LogArrivalDateTime" label="进出时间">
            </el-table-column>
        </el-table>
...
export default {
    ...
    methods: {
        ...
        loadRecords() {
            this.$ajax.get(this.$URL + '/acs/GetIoData', {
                params: {
